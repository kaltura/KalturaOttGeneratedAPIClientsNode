...
class messageTemplate{
	 ...
	 * @param messageType int possible values: Asset type – Series, Reminder,Churn (enum: KalturaMessageTemplateType)
	 ...
	 * @param messageType int The asset type to update its template (enum: KalturaMessageTemplateType)
