 ...
 *
 */
class PromotionListResponse extends ListResponse{
	
	constructor(object = null) {
		super(object);
		this.objectType = 'KalturaPromotionListResponse';
	}
	...
	/**
	 * @param objects array A list of promotions
	 */
	 setObjects(objects) {
	 	this.objects = objects;
	 }
}
module.exports.PromotionListResponse = PromotionListResponse;
