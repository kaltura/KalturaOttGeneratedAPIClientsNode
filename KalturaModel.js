...
class BulkUploadFilter extends Filter{
	 ...
	 * @return string
	 */
	 getFileObjectNameEqual() {
	 	return this.fileObjectNameEqual;
	 }
	
	/**
	 * @param fileObjectNameEqual string File&#39;s objectType name (must be type of KalturaOTTObject)
	 */
	 setFileObjectNameEqual(fileObjectNameEqual) {
	...
	/**
	 * @param userIdEqualCurrent bool Indicates if to get the BulkUpload list that created by current user or by the entire group
	 */
	 ...
	 * @return bool
	 */
	 getShouldGetOnGoingBulkUploads() {
	 	return this.shouldGetOnGoingBulkUploads;
	 }
	
	/**
	 * @param shouldGetOnGoingBulkUploads bool Indicates if to get the BulkUpload list that are stil in OnGoing process or finished
	 */
	 setShouldGetOnGoingBulkUploads(shouldGetOnGoingBulkUploads) {
