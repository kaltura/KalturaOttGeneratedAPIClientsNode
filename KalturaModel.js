...
class SemanticSubQuery extends kaltura.BaseObject{
	...
	/**
	 * @param text string The text content of the sub-query
	 */
	 setText(text) {
	 	this.text = text;
	 }
	...
	/**
	 * @param name TranslationToken The name of the sub-query
	 */
	 setName(name) {
	 	this.name = name;
	 }
...
class SemanticQuery extends kaltura.BaseObject{
	...
	/**
	 * @param subQueries array List of generated semantic sub-queries
	 */
	...
	/**
	 * @param title string Title of the semantic query
	 */
	 setTitle(title) {
	 	this.title = title;
	 }
...
class SemanticQueryPartnerConfiguration extends kaltura.BaseObject{
	...
	/**
	 * @param subQueriesCount int Number of sub-queries to generate for user query
	 */
	...
	/**
	 * @param defaultQueriesCount int Number of queries to generate for non-user query
	 */
	...
	/**
	 * @param assetsPerCollectionCount int Number of assets returned from search per collection
	 */
