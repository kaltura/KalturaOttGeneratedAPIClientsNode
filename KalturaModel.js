 ...
 *
 */
class DeviceReferenceDataFilter extends Filter{
 ...
 *
 */
class PasswordPolicyFilter extends Filter{
 ...
 *
 */
class HouseholdSegmentFilter extends Filter{
...
class CollectionFilter extends Filter{
	...
	/**
	 * @param assetUserRuleIdIn string comma-separated list of KalturaCollection.assetUserRuleId values.  Matching KalturaCollection objects will be returned by the filter
	 */
	 setAssetUserRuleIdIn(assetUserRuleIdIn) {
	 	this.assetUserRuleIdIn = assetUserRuleIdIn;
	 }
...
class PpvFilter extends Filter{
	...
	/**
	 * @param assetUserRuleIdIn string comma-separated list of KalturaPpv.assetUserRuleId values.  Matching KalturaPpv objects will be returned by the filter
	 */
	 setAssetUserRuleIdIn(assetUserRuleIdIn) {
	 	this.assetUserRuleIdIn = assetUserRuleIdIn;
	 }
 ...
 *
 */
class SmsAdapterProfileFilter extends Filter{
 ...
 *
 */
class DynamicListFilter extends Filter{
 ...
 *
 */
class HouseholdCouponFilter extends Filter{
 ...
 *
 */
class CategoryItemFilter extends Filter{
 ...
 *
 */
class CategoryVersionFilter extends Filter{
...
class ChannelsFilter extends ChannelsBaseFilter{
	...
	/**
	 * @param assetUserRuleIdIn string comma-separated list of KalturaChannel.assetUserRuleId values.  Matching KalturaChannel objects will be returned by the filter
	 */
	 setAssetUserRuleIdIn(assetUserRuleIdIn) {
	 	this.assetUserRuleIdIn = assetUserRuleIdIn;
	 }
...
class CampaignSearchFilter extends CampaignFilter{
	...
	/**
	 * @param assetUserRuleIdIn string Comma separated AssetUserRule Ids to filter by
	 */
	 setAssetUserRuleIdIn(assetUserRuleIdIn) {
	 	this.assetUserRuleIdIn = assetUserRuleIdIn;
	 }
 ...
 *
 */
class EventNotificationFilter extends Filter{
 ...
 *
 */
class IotFilter extends Filter{
 ...
 *
 */
class IotProfileFilter extends Filter{
 ...
 * value - The metadata value generated by the LLM, in a KalturaTranslationToken format
	...
	/**
	 * @param enrichedMetadata map A dictionary holding the names and values of the generated metadata.
 * key - the metadata name/key, e.g. ‘Genre’, ‘shortDescription’ etc.
 * value - The metadata value generated by the LLM, in a KalturaTranslationToken format
	 */
 ...
 * It is used to define which metadata fields will be extracted from the asset and sent for embeddings
	 * @return string
	 */
	 getVectorizedMetaIds() {
	 	return this.vectorizedMetaIds;
	 }
	
	/**
	 * @param vectorizedMetaIds string a String type holding a comma separated list of metadata IDs.
 * It is used to define which metadata fields will be extracted from the asset and sent for embeddings
	 */
	 setVectorizedMetaIds(vectorizedMetaIds) {
 ...
 *
 */
class DeviceReferenceData extends OTTObjectSupportNullable{
...
class DeviceReferenceDataListResponse extends ListResponse{
	...
	/**
	 * @param objects array A list of KalturaDeviceReferenceData
	 */
	 setObjects(objects) {
	 	this.objects = objects;
	 }
 ...
 *
 */
class PasswordPolicy extends OTTObjectSupportNullable{
 ...
 *
 */
class HouseholdSegment extends OTTObjectSupportNullable{
 ...
 *
 */
class SmsAdapterProfile extends OTTObjectSupportNullable{
 ...
 *
 */
class DynamicList extends OTTObjectSupportNullable{
 ...
 *
 */
class CategoryItem extends OTTObjectSupportNullable{
 ...
 *
 */
class CategoryVersion extends OTTObjectSupportNullable{
 ...
 *
 */
class Campaign extends OTTObjectSupportNullable{
 ...
 * If omitted than no limitation is enforced on the number of usages
	 * @return int
	 */
	 getMaxDiscountUsages() {
	 	return this.maxDiscountUsages;
	 }
	
	/**
	 * @param maxDiscountUsages int The number of times a household can use the discount module in this campaign.
 * If omitted than no limitation is enforced on the number of usages
	 */
	 setMaxDiscountUsages(maxDiscountUsages) {
 ...
 *
 */
class EventNotification extends OTTObjectSupportNullable{
 ...
 *
 */
class Iot extends OTTObjectSupportNullable{
 ...
 *
 */
class IotProfileAws extends OTTObjectSupportNullable{
...
class MediaFile extends AssetFile{
	...
	/**
	 * @param dynamicData map List of KalturaMediaFile&#39;s dynamic data keys
	 */
	 setDynamicData(dynamicData) {
	 	this.dynamicData = dynamicData;
	 }
...
class Subtitles extends kaltura.BaseObject{
	...
	/**
	 * @param fileName string a String type listing the file name that was uploaded
	 */
	...
	/**
	 * @param subtitlesType string can be either Processing/Success/Failed, per the last status updated by the aiMetadataGenerator micro-service
	 */
	 setSubtitlesType(subtitlesType) {
...
class SegmentationType extends kaltura.BaseObject{
	...
	/**
	 * @param assetUserRuleId int Asset User Rule Id
	 */
	 setAssetUserRuleId(assetUserRuleId) {
	 	this.assetUserRuleId = assetUserRuleId;
	 }
...
class CouponListResponse extends ListResponse{
	...
	/**
	 * @param objects array A list of Coupons
	 */
	 setObjects(objects) {
	 	this.objects = objects;
	 }
...
class DiscountDetailsListResponse extends ListResponse{
	...
	/**
	 * @param objects array A list of discount details
	 */
	 setObjects(objects) {
	 	this.objects = objects;
	 }
...
class TopicListResponse extends ListResponse{
	...
	/**
	 * @param objects array List of Topics
	 */
	 setObjects(objects) {
	 	this.objects = objects;
	 }
...
class IngestStatusEpgListResponse extends ListResponse{
	...
	/**
	 * @param objects array A list of IngestStatus
	 */
	 setObjects(objects) {
	 	this.objects = objects;
	 }
...
class IngestStatusEpgProgramResultListResponse extends ListResponse{
	...
	/**
	 * @param objects array list of KalturaIngestEpgProgramResult
	 */
	 setObjects(objects) {
	 	this.objects = objects;
	 }
...
class DynamicListListResponse extends ListResponse{
	...
	/**
	 * @param objects array A list of KalturaDynamicList
	 */
	 setObjects(objects) {
	 	this.objects = objects;
	 }
...
class Configurations extends kaltura.BaseObject{
	...
	/**
	 * @param isForceUpdate bool The default value for &quot;isForceUpdate&quot; is &quot;FALSE&quot;. When &quot;isForceUpdate&quot; is not populated it will revert to its default value
	 */
...
class CategoryItemListResponse extends ListResponse{
	...
	/**
	 * @param objects array A list of CategoryItem
	 */
	 setObjects(objects) {
	 	this.objects = objects;
	 }
...
class MediaFileType extends kaltura.BaseObject{
	...
	/**
	 * @param dynamicDataKeys string List of comma separated keys allowed to be used as KalturaMediaFile&#39;s dynamic data keys
	 */
	 setDynamicDataKeys(dynamicDataKeys) {
...
class CampaignListResponse extends ListResponse{
	...
	/**
	 * @param objects array A list of Campaigns
	 */
	 setObjects(objects) {
	 	this.objects = objects;
	 }
 ...
 *
 */
class IotListResponse extends ListResponse{
	
	constructor(object = null) {
		super(object);
		this.objectType = 'KalturaIotListResponse';
	}
...
module.exports.IotListResponse = IotListResponse;
 ...
 *
 */
class CaptionUploadData extends kaltura.BaseObject{
	
	constructor(object = null) {
		super(object);
		this.objectType = 'KalturaCaptionUploadData';
	}
	...
	/**
	 * @param captionType string The content type included in the caption file. Can be of SRT, WebVTT or free text without cues. Must also be in UTF-8 encoding
	 */
	 setCaptionType(captionType) {
...
module.exports.CaptionUploadData = CaptionUploadData;

/**
 *
 */
class CaptionUploadJob extends kaltura.BaseObject{
	
	constructor(object = null) {
		super(object);
		this.objectType = 'KalturaCaptionUploadJob';
	}
...
module.exports.CaptionUploadJob = CaptionUploadJob;

/**
 *
 */
class EnrichedMetadataResult extends kaltura.BaseObject{
	
	constructor(object = null) {
		super(object);
		this.objectType = 'KalturaEnrichedMetadataResult';
	}
...
module.exports.EnrichedMetadataResult = EnrichedMetadataResult;

/**
 *
 */
class MetaEnrichConfiguration extends kaltura.BaseObject{
	
	constructor(object = null) {
		super(object);
		this.objectType = 'KalturaMetaEnrichConfiguration';
	}
...
module.exports.MetaEnrichConfiguration = MetaEnrichConfiguration;
